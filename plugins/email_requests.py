...
from electrum_xmc.paymentrequest import PR_UNPAID, PR_PAID, PR_EXPIRED
from electrum_xmc.plugins import BasePlugin, hook
from electrum_xmc import util
from electrum_xmc.paymentrequest import PaymentRequest
from electrum_xmc.i18n import _
from electrum_xmc_gui.qt.util import text_dialog, EnterButton
...
class Plugin(BasePlugin):
    ...
    def init_qt(self, gui):
        from electrum_xmc_gui.qt.util import ThreadedButton
    ...
    def settings_dialog(self, x):
        from electrum_xmc_gui.qt.util import Buttons, CloseButton, OkButton
