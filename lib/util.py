...
def user_dir():
    if "HOME" in os.environ:
        return os.path.join(os.environ["HOME"], ".electrum-xmc")
    elif "APPDATA" in os.environ:
        return os.path.join(os.environ["APPDATA"], "Electrum-XMC")
    elif "LOCALAPPDATA" in os.environ:
        return os.path.join(os.environ["LOCALAPPDATA"], "Electrum-XMC")
    elif 'ANDROID_DATA' in os.environ:
        return "/sdcard/electrum-xmc/"
    else:
...
block_explorer_info = {
    'Mercatorcoin.com': ('http://ledger.mercatorcoin.com',
...
def create_URI(addr, amount, message):
    ...
    p = urlparse.ParseResult(scheme='xmc', netloc='', path=addr, params='', query='&'.join(query), fragment='')
