...
REQUEST_HEADERS = {'Accept': 'application/xmc-paymentrequest', 'User-Agent': 'Electrum'}
ACK_HEADERS = {'Content-Type':'application/xmc-payment','Accept':'application/xmc-paymentack','User-Agent':'Electrum'}
