...
from electrum_xmc import SimpleConfig, Wallet, WalletStorage, format_satoshis
from electrum_xmc.bitcoin import is_address, COIN
        ...
        if event["name"] == "click":
            ...
            if id=="buttonPay":
                ...
                if not is_address(recipient):
                    modal_dialog('Error','Invalid XMC address')
                    continue
...
def receive_loop():
    ...
    while out is None:
        ...
        if not event:
            ...
            amount = modal_input('Amount', 'Amount you want to receive (in XMC). ', format_satoshis(receive_amount) if receive_amount else None, "numberDecimal")
