...
from electrum_xmc.i18n import _, set_language
from electrum_xmc.util import print_error, print_msg
from electrum_xmc.plugins import run_hook, always_hook
from electrum_xmc import WalletStorage, Wallet
from electrum_xmc.bitcoin import MIN_RELAY_TX_FEE
...
class ElectrumGui:
    ...
    def build_tray_menu(self):
        ...
        m.addSeparator()
        m.addAction(_("Exit Electrum-XMC"), self.close)
    ...
    def init_lite(self):
        ...
        if not self.check_qt_version():
            if self.config.get('lite_mode') is True:
                msg = "Electrum-XMC was unable to load the 'Lite GUI' because it needs Qt version >= 4.7.\nChanging your config to use the 'Classic' GUI"
    ...
    def main(self, url):
        ...
        self.tray.setToolTip('Electrum-XMC')
