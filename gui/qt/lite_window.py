...
try:
    ...
    print "You need to have PyQT installed to run Electrum-XMC in graphical mode."
...
from electrum_xmc.bitcoin import is_valid
...
import re
import time
from electrum_xmc.wallet import Wallet, WalletStorage
import webbrowser
...
from electrum_xmc.version import ELECTRUM_VERSION as electrum_version
from electrum_xmc.util import format_satoshis, age
...
class MiniWindow(QDialog):
    ...
    def __init__(self, actuator, expand_callback, config):
        ...
        self.address_input.setPlaceholderText(_("Enter a xmc address or contact"))
        ...
        self.setWindowTitle("Electrum-XMC")
    ...
    def set_balances(self, btc_balance):
        ...
        self.setWindowTitle("Electrum-XMC %s - %s %s" % (electrum_version, amount, unit))

    def amount_input_changed(self, amount_text):
        """Update the number of xmc displayed."""
...
class BalanceLabel(QLabel):
    ...
    def set_balance_text(self, amount, unit, quote_text):
        """Set the amount of xmc in the gui."""
        if self.state == self.SHOW_CONNECTING:
...
class MiniActuator:
    ...
    def set_configured_currency(self, set_quote_currency):
        ...
        # currency can be none when Electrum-XMC is used for the first
    ...
    def send(self, address, amount, parent_window):
        """Send xmc to the target address."""
