...
from electrum_xmc.util import print_error, InvalidPassword
from electrum_xmc.bitcoin import is_valid, COIN
from electrum_xmc.wallet import NotEnoughFunds
...
from electrum_xmc.util import format_satoshis, parse_URI
...
class ElectrumWindow:
    ...
    def __init__(self, wallet, config, network):
        ...
        from electrum_xmc.util import StoreDict
